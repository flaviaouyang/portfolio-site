const Hobby = () => {
  return (
    <div className="about-text">
      ...
      <ul>
          <li><a href="https://mubi.com/films/milou-en-mai">Milou en mai</a>, by Louis Malle</li>
          <li><a href="https://mubi.com/films/zero-fucks-given">RIEN À FOUTRE</a>, by Julie Lecoustre</li>
